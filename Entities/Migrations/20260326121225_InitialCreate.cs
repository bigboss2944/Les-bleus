        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeTaxPrice = table.Column<float>(type: "REAL", nullable: false),
                    Tax = table.Column<float>(type: "REAL", nullable: false),
                    ProductTypeDiscriminator = table.Column<string>(type: "TEXT", maxLength: 21, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShopId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BicycleName = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockRequests_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhysicalProducts_ProductTypes_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseLoyaltyPoint = table.Column<bool>(type: "INTEGER", nullable: false),
                    Tax = table.Column<float>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TypeOfBike = table.Column<string>(type: "TEXT", nullable: true),
                    Category = table.Column<string>(type: "TEXT", nullable: true),
                    Reference = table.Column<string>(type: "TEXT", nullable: true),
                    FreeTaxPrice = table.Column<float>(type: "REAL", nullable: false),
                    Tax = table.Column<float>(type: "REAL", nullable: false),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false),
                    Exchangeable = table.Column<bool>(type: "INTEGER", nullable: false),
                    Insurance = table.Column<bool>(type: "INTEGER", nullable: false),
                    Deliverable = table.Column<bool>(type: "INTEGER", nullable: false),
                    OrderIdOrder = table.Column<long>(type: "INTEGER", nullable: true),
                    CustomerId = table.Column<string>(type: "TEXT", nullable: true),
                    ShopId = table.Column<long>(type: "INTEGER", nullable: true),
                    Size = table.Column<float>(type: "REAL", nullable: false),
                    Weight = table.Column<float>(type: "REAL", nullable: false),
                    ...
                    Electric = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bicycles_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bicycles_Orders_OrderIdOrder",
                        column: x => x.OrderIdOrder,
                        principalTable: "Orders",
                        principalColumn: "IdOrder");
                    table.ForeignKey(
                        name: "FK_Bicycles_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bicycles_OrderIdOrder",
                table: "Bicycles",
                column: "OrderIdOrder");

            migrationBuilder.CreateIndex(
                name: "IX_Bicycles_ShopId",
                table: "Bicycles",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalProducts_ProductTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockRequests_RequestedById",
                table: "StockRequests",
